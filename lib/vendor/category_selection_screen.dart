...
import 'package:eimi_buy_or_sell_app/vendor/sub_category_selection_screen.dart';
                              ...
                              Column(
                                children:  [
                                  ...
                                  customThemeText(
                                      ...
                                      22,fontWeight: FontWeight.w700,color: AppColors.black
                                  ),
        ...
        itemBuilder: (context, index) {
          return InkWell(
            onTap: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const SubCategorySelectionScreen()),
              );
            },
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Image.asset("assets/images/home_image.png",height: deviceHeight(context) * 0.12,width: deviceWidth(context)* 0.3,),
                ),
                VerticalSpace(),
                customThemeText(
